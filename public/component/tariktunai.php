...
<div class="bg-white w-fit mx-auto my-10">
    <div class="flex flex-col gap-2 items-center">
        <h1 class="text-3xl font-semibold text-center">Tarik Tunai</h1>
        <div class="flex flex-col mt-6 gap-y-3">
            <div class="flex flex-col">
                <label class="text-xl" for="tarik">Jumlah</label>
                <input class=" p-2 text-xl border-b border-gray-200 
                     bg-gray-100 rounded-tl-md rounded-tr-md" type="number" name="tarik" id="tarik">
            </div>
            <div class="flex flex-col">
                <label class="text-xl" for="nis">NIS/ID Kantin</label>
                <input class=" p-2 text-xl border-b border-gray-200 
                     bg-gray-100 rounded-tl-md rounded-tr-md" type="text" name="nis" id="nis">
            </div>
            <div class="flex flex-col">
